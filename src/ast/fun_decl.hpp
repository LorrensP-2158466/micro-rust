...
namespace mr {
    namespace ast {
        ...
        class FunDecl : public Item {
          ...
          public:
            FunDecl(std::string id, std::vector<FunArg> args,
                    ast::Type ret_type, Unique<expr::BlockExpr> body)
                : _id(id), _args(args), _ret_type(ret_type),
                  _body(std::move(body)) {}

            static Unique<FunDecl>
            make_unique(std::string id, std::vector<FunArg> args,
                        ast::Type               ret_type,
            ...
            ast::Type return_type() const { return _ret_type; }
