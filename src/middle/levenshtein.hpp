...
namespace mr {
    namespace middle {
        ...
        relative_similar(const std::string& word1, const std::string& word2) {
            ...
            return distance <= (maxLength * 0.3 + 1) ? std::make_optional(distance)
                                                     : std::nullopt;
        }
    } // namespace middle
} // namespace mr