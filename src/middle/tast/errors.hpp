        ...
        namespace tast {
            namespace errors {
                ...
                static inline error::Diagnostic mismatched_return_types(
                    const types::Ty& found, location found_loc, const types::Ty& expected,
                    ...
                    return error::Diagnostic{
                        ...
                        std::vector{
                                ...
                                found_loc,
                                fmt::format(
                                    "Expected `{}` but found `{}`", expected, found
                                ),
                                error::Style::Primary
                            }, },
                    };
                ...
                static inline error::Diagnostic mismatched_types(
                    const types::Ty& found, const types::Ty& expected, location loc
                ) {
                    return error::Diagnostic{
                        error::Level::Error,
                ...
                static inline error::Diagnostic mismatched_if_else_types(
                    const types::Ty& found, location else_t_loc,
                    const types::Ty& expected, location if_t_loc, location if_loc,
                    location else_loc
                ) {
                    return error::Diagnostic{
                        error::Level::Error,
                        ...
                        {error::DiagnosticLabel{if_loc, "", error::Style::Secondary},
                          error::DiagnosticLabel{
                             if_t_loc, "expected because of this", error::Style::Secondary
                ...
                static inline error::Diagnostic unknown_field(
                    std::string field, const types::Ty& actual_type, location loc
                ) {
                    return error::Diagnostic{
                        error::Level::Error,
                        ...
                        loc,
                        std::vector{error::DiagnosticLabel{
                            loc, "unkown field", error::Style::Primary
                        }},
                    };
                }

                static inline error::Diagnostic
                no_field_on_primitive(const types::Ty& prim, location loc) {
                    return error::Diagnostic{
                        error::Level::Error,
                        fmt::format(
                ...
                static inline error::Diagnostic ident_not_found(
                    const std::string& ident, location loc, std::string possible_help = ""
                ) {
                    return error::Diagnostic{
                        error::Level::Error,
