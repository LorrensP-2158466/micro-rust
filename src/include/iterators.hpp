    ...
    namespace iterators {
        ...
        template <typename... Iters> class zip_iterator {
          ...
          public:
            ...
            zip_iterator(Iters... its) : iterators(its...) {}
            ...
            value_type operator*() {
                return std::apply(
                    [](auto&... its) { return std::make_tuple((*its)...); }, iterators
                );
            }

            value_type operator*() const {
                return std::apply(
                    [](const auto&... its) { return std::make_tuple((*its)...); },
                    iterators
                );
            }
        ...
        template <typename... Containers> class zip_view {
          ...
          public:
            zip_view(Containers&... conts) : containers(conts...) {}

            auto begin() {
                return std::apply(
                    [](auto&... conts) { return make_zip_iterator(conts.begin()...); },
                    containers
                );
            }
            ...
            auto end() {
                return std::apply(
                    [](auto&... conts) { return make_zip_iterator(conts.end()...); },
                    containers
                );
            }
            ...
            auto begin() const {
                return std::apply(
                    [](const auto&... conts) {
                        return make_zip_iterator(conts.begin()...);
                    },
                    containers
                );
            }
            ...
            auto end() const {
                return std::apply(
                    [](const auto&... conts) {
                        return make_zip_iterator(conts.end()...);
                    },
                    containers
                );
            }
